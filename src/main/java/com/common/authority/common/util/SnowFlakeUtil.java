...
public class SnowFlakeUtil {
    ...
    // 1665992466802：2022-10-17 15:41:06
    private static final long INIT_EPOCH = 1665992466802L;

    // 时间位取&
    private static final long TIME_BIT = 0b1111111111111111111111111111111111111111110000000000000000000000L;

    // 记录最后使用的毫秒时间戳，主要用于判断是否同一毫秒，以及用于服务器时钟回拨判断（时钟回拨可能造成重复ID）
