...
public class PrivilegeController {
    ...
    @PostMapping
    @ResponseBody
    public ResultData add(@RequestBody @Valid PrivilegeAddParamVo privilegeAddParamVo) {
    ...
    @ResponseBody
    @AuthPassPort
    public ResultData update(@RequestBody @Valid PrivilegeAddParamVo privilegeAddParamVo) {
